class Brain:
    ...
    def make_deck(self, player_type):
        for i in range(26):
            card = self._deck.draw()
            player_type.add_card(card)
    ...
    def start_battle(self, cards_from_war=None):
        ...
        if winner == Brain.PLAYER:
            print("\nYou won this round!")
            self.add_cards_to_player_type(self._player, cards_won)
        elif winner == Brain.COMPUTER:
            print("\nThe computer won this round.")
            self.add_cards_to_player_type(self._computer, cards_won)
        else:
    ...
    def add_cards_to_player_type(self, player_type, list_of_cards):
